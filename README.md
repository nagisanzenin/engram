...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/selftest-229%2F229-3E7D5A.svg" alt="229/229 checks">
...
| `selftest` | 229 checks| 217 checks| 214 checks| 213 checks| 213 checks| 207 checks| 201 checks| 200 checks| 192 checks| 191 checks over the FSRS math, state machine, adherence/retention arithmetic, the grader-audit statistics, and every hardened boundary |
